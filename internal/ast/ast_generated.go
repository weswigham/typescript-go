...
func (f *NodeFactory) ReleaseArenas() {
	f.arrayTypeNodeArena.Release()
	f.binaryExpressionArena.Release()
	f.blockArena.Release()
	f.callExpressionArena.Release()
	f.conditionalExpressionArena.Release()
	f.constructSignatureDeclarationArena.Release()
	f.elementAccessExpressionArena.Release()
	f.expressionStatementArena.Release()
	f.expressionWithTypeArgumentsArena.Release()
	f.functionDeclarationArena.Release()
	f.functionTypeNodeArena.Release()
	f.heritageClauseArena.Release()
	f.identifierArena.Release()
	f.ifStatementArena.Release()
	f.importSpecifierArena.Release()
	f.indexedAccessTypeNodeArena.Release()
	f.interfaceDeclarationArena.Release()
	f.intersectionTypeNodeArena.Release()
	f.jsdocArena.Release()
	f.jsdocDeprecatedTagArena.Release()
	f.jsdocTextArena.Release()
	f.jsdocUnknownTagArena.Release()
	f.keywordExpressionArena.Release()
	f.keywordTypeNodeArena.Release()
	f.literalTypeNodeArena.Release()
	f.methodSignatureDeclarationArena.Release()
	f.modifierListArena.Release()
	f.nodeListArena.Release()
	f.numericLiteralArena.Release()
	f.parameterDeclarationArena.Release()
	f.parenthesizedExpressionArena.Release()
	f.parenthesizedTypeNodeArena.Release()
	f.prefixUnaryExpressionArena.Release()
	f.propertyAccessExpressionArena.Release()
	f.propertyAssignmentArena.Release()
	f.propertySignatureDeclarationArena.Release()
	f.returnStatementArena.Release()
	f.stringLiteralArena.Release()
	f.tokenArena.Release()
	f.typeAliasDeclarationArena.Release()
	f.typeLiteralNodeArena.Release()
	f.typeOperatorNodeArena.Release()
	f.typeParameterDeclarationArena.Release()
	f.typeReferenceNodeArena.Release()
	f.unionTypeNodeArena.Release()
	f.variableDeclarationArena.Release()
	f.variableDeclarationListArena.Release()
	f.variableStatementArena.Release()
}
